...
if [ "$USER" = root ]; then
   PS1='\[\033[01;31m\]$(statstring)\[\033[00m\]${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u@\h\[\033[00m\] \[\033[${PS1_LOC_COL}\]\w\[\033[00m\]\[\033[0m\]\[\033[0;35m\]$(kube_cluster)\[\033[0m\]\[\033[0;36m\]$(bluemix_account)\[\033[0m\]\[\033[0;37m\]$(parse_git_branch)\[\033[0m\] \$ '
 else
   PS1='\[\033[01;31m\]$(statstring)\[\033[00m\]${debian_chroot:+($debian_chroot)}\[\033[${PS1_NAME_COL}\]\u@\h\[\033[00m\] \[\033[${PS1_LOC_COL}\]\w\[\033[00m\]\[\033[0m\]\[\033[0;35m\]$(kube_cluster)\[\033[0m\]\[\033[0;36m\]$(bluemix_account)\[\033[0m\]\[\033[0;37m\]$(parse_git_branch) \$ '
fi
